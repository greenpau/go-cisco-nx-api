...
type Interface struct {
	...
	Counters    struct {
		...
		InputBroadcastPackets  uint64 `json:"input_mcast_packets",xml:"input_mcast_packets"`
		InputMulticastPackets  uint64 `json:"input_bcast_packets",xml:"input_bcast_packets"`
		...
		OutputBroadcastPackets uint64 `json:"output_mcast_packets",xml:"output_mcast_packets"`
		OutputMulticastPackets uint64 `json:"output_bcast_packets",xml:"output_bcast_packets"`
